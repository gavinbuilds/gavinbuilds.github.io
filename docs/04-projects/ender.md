...
section: projects
order: 60
subtitle: The printer that taught me by not working
summary: >
  My first printer, with the most warped build plate on Amazon. I went straight
  into swapping the mainboard, flashing firmware, and installing a BLTouch — and
  didn't have it printing for months.
...
Now the setup has a 24v to 5v DC-DC converter to power the pi (I stole this from my [Voron 0.1]({{ '/docs/04-projects/voron.html' | relative_url }}) when I upgraded)
![Front electronics enclosure](../04-projects/images/ender/23- front e1.jpg)

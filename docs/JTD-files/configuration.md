...
See [Customization]({{ site.baseurl }}{% link docs/JTD-files/customization.md %}) for more information.
...
See [Callouts]({{ site.baseurl }}{% link docs/JTD-files/callouts.md %}) for more information.
